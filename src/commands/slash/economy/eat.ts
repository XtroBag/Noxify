...
//         const userItems = client.utils.items.getInventoryItems(newUser, "meal");
//         const validItems = client.utils.items.getItemsByType("meal");
...
//       const items = client.utils.items.getInventoryItems(user, 'meal');
